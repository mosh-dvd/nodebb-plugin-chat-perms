                    ...
                    <form id="chat-perms-settings">
                        ...
                        <fieldset>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="adminUids" name="adminUids" placeholder="1,2,3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="allowChatGroup" name="allowChatGroup" placeholder="allowChat">
                                <p class="form-text">שם הקבוצה שמותר להם צ'אט ללא תנאים</p>
                            </div>
                            
                            <div class="mb-3">
                                <label class="form-label" for="denyChatGroup">קבוצת חסומים</label>
                                <input type="text" class="form-control" id="denyChatGroup" name="denyChatGroup" placeholder="denyChat">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="minReputation" name="minReputation" value="10">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="minPosts">פוסטים מינימליים</label>
                                    <input type="number" class="form-control" id="minPosts" name="minPosts" value="5">
                                </div>
                            </div>
                        </fieldset>
                        ...
                        <fieldset>
                            ...
                            <div class="form-check form-switch mb-3">
                                <input class="form-check-input" type="checkbox" id="warningEnabled" name="warningEnabled">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="warningMessage" name="warningMessage" rows="2">שים לב: ההנהלה יכולה לצפות בהודעות הצ'אט</textarea>
                            </div>
                            
                            <div class="mb-3">
                                <label class="form-label" for="warningDisplayType">סוג תצוגה</label>
                                <select class="form-select" id="warningDisplayType" name="warningDisplayType">
                        ...
                        <fieldset>
                            ...
                            <div class="form-check form-switch mb-3">
                                <input class="form-check-input" type="checkbox" id="keywordAlertsEnabled" name="keywordAlertsEnabled">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="keywordList" name="keywordList" rows="3" placeholder="מילה1&#10;מילה2&#10;מילה3"></textarea>
                                <p class="form-text">מילה אחת בכל שורה</p>
                            </div>
                            
                            <div class="mb-3">
                                <label class="form-label" for="alertRecipientUids">מקבלי התראות</label>
                                <input type="text" class="form-control" id="alertRecipientUids" name="alertRecipientUids" placeholder="1,2">
                        ...
                        <fieldset>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="chatNotYetAllowedMessage" name="chatNotYetAllowedMessage" placeholder="עליך לצבור וותק לפני שתוכל להשתמש בצ'אט">
                            </div>
                            
                            <div class="mb-3">
                                <label class="form-label" for="chatDeniedMessage">הודעה למשתמש חסום</label>
                                <input type="text" class="form-control" id="chatDeniedMessage" name="chatDeniedMessage" placeholder="הגישה שלך לצ'אט נחסמה">
                            </div>
                        </fieldset>
                    </form>
                </div>
